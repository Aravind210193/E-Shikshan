...
export const adminCourseAPI = {
  ...
  // Lesson Management
  addLesson: (id, data) => adminAPI.post(`/courses/${id}/lessons`, data),
  updateLesson: (id, lessonId, data) => adminAPI.put(`/courses/${id}/lessons/${lessonId}`, data),
  deleteLesson: (id, lessonId) => adminAPI.delete(`/courses/${id}/lessons/${lessonId}`),
  // Project Management
  addProject: (id, data) => adminAPI.post(`/courses/${id}/projects`, data),
  updateProject: (id, projectId, data) => adminAPI.put(`/courses/${id}/projects/${projectId}`, data),
  deleteProject: (id, projectId) => adminAPI.delete(`/courses/${id}/projects/${projectId}`),
  // Assignment Management
  addAssignment: (id, data) => adminAPI.post(`/courses/${id}/assignments`, data),
  updateAssignment: (id, assignmentId, data) => adminAPI.put(`/courses/${id}/assignments/${assignmentId}`, data),
  deleteAssignment: (id, assignmentId) => adminAPI.delete(`/courses/${id}/assignments/${assignmentId}`),
  // Resource Management
  addResource: (id, data) => adminAPI.post(`/courses/${id}/resources`, data),
  deleteResource: (id, resourceId) => adminAPI.delete(`/courses/${id}/resources/${resourceId}`),
  getEnrollments: (id) => adminAPI.get(`/courses/${id}/enrollments`),
  getInstructors: () => adminAPI.get('/courses/instructors'),
};
