...
//   return (
//      <div className="  md:flex-row  flex flex-col items-center min-h-screen   justify-center px-4">
//       <div className="  m-20 flex flex-col md:flex-row max-w-5xl   min-w-xl   border border-red-400 rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center p-6 md:p-10 bg-gray-900">
          <div className="w-full max-w-md">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full py-3 bg-blue-500 hover:bg-blue-600 text-white rounded-md font-semibold shadow-md transition"
              >
                Login
              </button>
            </form>
