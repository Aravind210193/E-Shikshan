    ...
    role === 'course_manager'
      ...
      : [
        ...
        { path: `${base}/roadmaps`, label: "Roadmaps", icon: Map },
        {
          ...
          icon: Folder,
          submenu: [
            { path: `${base}/content`, label: "All Content", icon: FileText },
            { path: `${base}/branches`, label: "Branches", icon: Folder },
            { path: `${base}/education-levels`, label: "Education Levels", icon: School },
            { path: `${base}/subjects`, label: "Subjects", icon: BookOpen },
            { path: `${base}/programs`, label: "Programs", icon: BookMarked },
            { path: `${base}/folders`, label: "Folders & PDFs", icon: FolderOpen },
          ]
        },
