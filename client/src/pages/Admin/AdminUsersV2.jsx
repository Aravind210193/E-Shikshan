...
import { Search, Eye, CheckCircle, XCircle, ShieldCheck, RotateCcw, Trash2, PlusCircle, Braces, Pencil } from "lucide-react";
...
const AdminUsers = () => {
  ...
  const handleGrantAccess = async () => {
    ...
    if (!grantCourseId) {
      toast.error("Please select a course to grant access");
      return;
    }
              ...
              <div className="mb-8 bg-gray-700/30 border border-gray-700 rounded-xl p-4">
                <div className="flex flex-col md:flex-row md:items-end gap-3">
                  <div className="flex-1">
                    <label className="block text-sm text-gray-400 mb-1">Grant course access</label>
                    <select
